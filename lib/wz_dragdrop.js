/*
Note: Some modifications have been made to this file by
Kennedy Rose. Get the original script at the URLs listed
below.
...
function DRAG(d_ev)
{
	// Added if statement to disable dragging during load
	if (loadingscreen == 0) {
